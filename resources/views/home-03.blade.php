	...
	<header class="header3">
		...
		<div class="container-menu-header-v3">
			<div class="wrap_header3 p-t-74">
				<!-- Logo -->
				<a href="index.blade.php" class="logo3">
...
<div class="container1-page">
	...
	<div class="pos-relative">
		<div class="flex-c-m size22 bg0 s-text21 ab-b-l op-0-9">
			20% off everything!
			<a href="product.blade.php" class="s-text22 hov6 p-l-5">
				Shop Now
			</a>
	...
	<!-- Banner2 -->
	<div class="banner2 bg5 p-t-55 p-b-55 bg-img1" style="background-image: url(images/bg-banner-02.jpg);">
		<div class="container">
