...
@section('content')
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url({{asset('images/heading-pages-05.jpg')}});">
				...
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.blade.php" class="item-blog-img pos-relative dis-block hov-img-zoom">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="blog-detail.blade.php" class="m-text24">
								...
								<a href="blog-detail.blade.php" class="s-text20">
									Continue Reading
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.blade.php" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="{{asset('images/blog-08.jpg')}}" alt="IMG-BLOG">
